...
- The row identity is correct.
- The change is authorized.
- The action affects only the intended member.
...
- The member row shows the expected badge, tag, or qualification state.
- The member picker shows the member correctly for duty roles.

## When To Escalate

Escalate if eligibility or access changes conflict with policy or source records.
