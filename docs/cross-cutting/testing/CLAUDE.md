...
- Single domain testing → Document in domain CLAUDE.md
...
**Related**:
- [Backend Testing Standards](../../../../apps/backend/tests/CLAUDE.md)
- [Repository Testing](../../../../apps/backend/src/repositories/CLAUDE.md#testing-requirements)
