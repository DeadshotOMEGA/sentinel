...
export type ChipColor = "default" | "primary" | "secondary" | "success" | "warning" | "danger" | "blue" | "green" | "pink" | "purple" | "red" | "yellow" | "cyan" | "zinc"
export type ChipSize = "sm" | "md" | "lg"

const baseClasses = "inline-flex items-center justify-center rounded-full px-2.5 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 gap-1.5 transition-all"
...
const variantColorClasses: Record<ChipVariant, Record<ChipColor, string>> = {
  ...
  bordered: {
    default: "border-2 bg-transparent border-zinc-300 text-zinc-700 dark:border-zinc-600 dark:text-zinc-300",
  ...
  faded: {
    default: "border-2 border-zinc-200 bg-zinc-100/50 text-zinc-600 dark:border-zinc-700 dark:bg-zinc-800/50 dark:text-zinc-400",
    primary: "border-2 border-primary/30 bg-primary/10 text-primary/80",
    secondary: "border-2 border-secondary/30 bg-secondary/20 text-secondary-content/80",
    success: "border-2 border-emerald-300 bg-emerald-50 text-emerald-600 dark:border-emerald-800 dark:bg-emerald-950/50 dark:text-emerald-400",
    warning: "border-2 border-amber-300 bg-amber-50 text-amber-600 dark:border-amber-800 dark:bg-amber-950/50 dark:text-amber-400",
    danger: "border-2 border-red-300 bg-red-50 text-red-600 dark:border-red-800 dark:bg-red-950/50 dark:text-red-400",
    blue: "border-2 border-blue-300 bg-blue-50 text-blue-600 dark:border-blue-800 dark:bg-blue-950/50 dark:text-blue-400",
    green: "border-2 border-green-300 bg-green-50 text-green-600 dark:border-green-800 dark:bg-green-950/50 dark:text-green-400",
    pink: "border-2 border-pink-300 bg-pink-50 text-pink-600 dark:border-pink-800 dark:bg-pink-950/50 dark:text-pink-400",
    purple: "border-2 border-purple-300 bg-purple-50 text-purple-600 dark:border-purple-800 dark:bg-purple-950/50 dark:text-purple-400",
    red: "border-2 border-red-300 bg-red-50 text-red-600 dark:border-red-800 dark:bg-red-950/50 dark:text-red-400",
    yellow: "border-2 border-yellow-300 bg-yellow-50 text-yellow-600 dark:border-yellow-800 dark:bg-yellow-950/50 dark:text-yellow-400",
    cyan: "border-2 border-cyan-300 bg-cyan-50 text-cyan-600 dark:border-cyan-800 dark:bg-cyan-950/50 dark:text-cyan-400",
    zinc: "border-2 border-zinc-300 bg-zinc-50 text-zinc-600 dark:border-zinc-800 dark:bg-zinc-950/50 dark:text-zinc-400",
  },
  shadow: {
    default: "bg-zinc-200 text-zinc-800 shadow-md shadow-zinc-400/50 dark:bg-zinc-700 dark:text-zinc-200 dark:shadow-zinc-900/50",
