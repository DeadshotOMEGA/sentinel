...
import type { AdminUser, AdminUserWithPassword, AdminRole } from '@sentinel/types'
...
function mapToAdminUserWithPassword(
  dbUser: Pick<
    PrismaAdminUser,
    | 'id'
    | 'username'
      ...
      data: {
        ...
        fullName:
          data.firstName && data.lastName
            ? buildFullName(data.firstName, data.lastName)
            : data.displayName,
