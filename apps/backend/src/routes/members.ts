  ...
  createMember: async ({ body, req }: { body: CreateMemberInput; req: Request }) => {
    try {
      ...
      const member = await memberRepo.create({
        ...
        mess: body.mess,
        moc: body.moc,
        classDetails: body.classDetails,
        email: body.email,
        homePhone: body.homePhone,
        mobilePhone: body.mobilePhone !== undefined ? body.mobilePhone : body.phoneNumber,
      ...
      await logRequestAudit(auditRepo, req, {
        ...
        details: {
          ...
          previousState: {
            ...
            employeeNumber: existingMember.employeeNumber ?? null,
            divisionId: existingMember.divisionId ?? null,
            mess: existingMember.mess ?? null,
            moc: existingMember.moc ?? null,
            classDetails: existingMember.classDetails ?? null,
            email: existingMember.email ?? null,
            homePhone: existingMember.homePhone ?? null,
            mobilePhone: existingMember.mobilePhone ?? null,
            phoneNumber: existingMember.mobilePhone ?? existingMember.homePhone ?? null,
          ...
          currentState: {
            ...
            employeeNumber: finalMember.employeeNumber ?? null,
            divisionId: finalMember.divisionId ?? null,
            mess: finalMember.mess ?? null,
            moc: finalMember.moc ?? null,
            classDetails: finalMember.classDetails ?? null,
            email: finalMember.email ?? null,
            homePhone: finalMember.homePhone ?? null,
            mobilePhone: finalMember.mobilePhone ?? null,
            phoneNumber: finalMember.mobilePhone ?? finalMember.homePhone ?? null,
