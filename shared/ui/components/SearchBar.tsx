...
interface SearchBarProps {
  ...
  'aria-label'?: string;
  /** Whether to enable Cmd/Ctrl+K global shortcut */
      ...
      endContent={
        localValue && (
          <button
            ...
            className="text-default-400 hover:text-default-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-full p-0.5"
          >
