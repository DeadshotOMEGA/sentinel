...
export default function SkipNav({ links }) {
    ...
    const handleSkip = (event, targetId) => {
    ...
    return (_jsxs("div", { ref: skipLinksRef, className: "skip-nav", role: "navigation", "aria-label": "Skip navigation", children: [links.map((link) => (_jsx("a", { href: `#${link.targetId}`, className: "skip-nav-link", onClick: (e) => handleSkip(e, link.targetId), children: link.label }, link.id))), _jsx("style", { children: `
        .skip-nav {
          position: fixed;
          top: 0;
          left: 0;
