 ...
 */
export function getMessPriority(mess) {
    if (!mess)
        return 99;
 ...
 */
export function getRankPriority(rank) {
    if (!rank)
        return 100;
 ...
 */
export function sortMembersByMess(members) {
