...
import { CreateCheckinSchema, BulkCreateCheckinsSchema, UpdateCheckinSchema, CheckinWithMemberResponseSchema, CheckinListQuerySchema, CheckinListResponseSchema, PresenceStatusResponseSchema, ErrorResponseSchema, IdParamSchema, SuccessResponseSchema, BulkOperationResponseSchema, } from '../schemas/index.js';
...
export const checkinContract = c.router({
    getCheckins: {
        ...
        description: 'Get paginated list of checkins with optional filtering by member, division, date range, and direction',
    },
    getCheckinById: {
        method: 'GET',
...
//# sourceMappingURL=checkin.contract.js.map